...
class DatabaseWriter:
    ...
    def append_chunk(self, op_type='pandas'):
        if op_type != 'pandas':
...
writer = DatabaseWriter('table1', df)
writer.make_connection(db='table')
writer.get_database_table()
writer.append_chunk(op_type='pandas')
